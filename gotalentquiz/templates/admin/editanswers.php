...
<div id="container" class="quiz">
        <div class="row">
          <div id="intro" class="col-md-8 col-md-offset-2">
              ...
              <div><a class="btn btn-primary" href="<?php echo $root; ?>/admin/quiz/<?php echo $quizid; ?>/"><span class="glyphicon glyphicon-arrow-left"></span> Voltar para os detalhes do Quiz</a></div>
                    ...
                    <div class="col-md-7">
                        ...
                        <!--<h4><span id="questiontext"><?php //echo $question; ?></span> <a id="editor" class="edit"><span class="glyphicon glyphicon-pencil"></span></a></h4>-->
                            ...
                            <table id="answers" class="table table-responsive table-hover table-bordered">
                                <thead>
                                    <tr><th style="text-align: center;">Resposta Correta</th><th>Texto</th></tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $i = 1;
                            ...
                            <p>
                                <button type="submit" class="btn btn-success">Salvar <span class="glyphicon glyphicon-ok"></span></button>
